const projects = [
    {
        ...
        category: "web",
        description:
            "A responsive multi-page portfolio website built with semantic HTML, CSS, and JavaScript. It focuses on accessibility, clean design, and clear communication.",
    ...
    },
    {
        ...
        category: "school",
        description:
            "A class project focused on building a structured and visually organized recipe experience using modern layout and component styling.",
    ...
    },
    {
        ...
        category: "web",
        description:
            "A web application concept for browsing hiking information with clear layout, data presentation, and interaction patterns.",
        technologies: ["HTML", "CSS", "JavaScript"],
    ...
    },
    {
        ...
        category: "data",
        description:
            "A machine learning project focused on predicting housing prices using engineered features, evaluation metrics, and model tuning.",
    ...
    },
    {
        ...
        category: "python",
        description:
            "A data analysis and classification project using structured data, model evaluation, and business-focused interpretation of results.",
    ...
    },
    {
        ...
        category: "data",
        description:
            "Database and data workflow projects involving SQL queries, table structure design, and transforming data for reporting and analysis.",
    ...
    },
    {
        ...
        category: "school",
        description:
            "A group of school projects demonstrating steady growth in layout design, JavaScript logic, accessibility, and responsive development.",
        technologies: ["HTML", "CSS", "JavaScript"],
